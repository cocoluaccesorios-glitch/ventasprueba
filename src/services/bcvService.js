...
// ========================================
// VERSIÓN 5.0 - ARCHIVO LIMPIO SIN DUPLICACIONES
// ========================================
// Timestamp: 2025-09-23T23:45:00Z
// Archivo completamente limpio sin funciones duplicadas
...
export async function obtenerTasaBCV() {
  try {
    console.log('🚀 [VERSIÓN 5.0] ARCHIVO LIMPIO - Solo base de datos!')
