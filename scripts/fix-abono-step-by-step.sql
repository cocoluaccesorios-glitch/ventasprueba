-- =====================================================
-- SCRIPT PASO A PASO PARA ARREGLAR SISTEMA DE ABONOS
-- =====================================================
...
-- PASO 2: ACTUALIZAR TODOS LOS VALORES DE TASA_BCV A 166.58 PRIMERO
UPDATE pedidos SET tasa_bcv = 166.58 WHERE tasa_bcv IS NOT NULL;

-- PASO 3: AHORA CAMBIAR EL TIPO DE COLUMNA
ALTER TABLE pedidos ALTER COLUMN tasa_bcv TYPE DECIMAL(10,2);

-- PASO 4: CREAR TABLA TASA_CAMBIO
