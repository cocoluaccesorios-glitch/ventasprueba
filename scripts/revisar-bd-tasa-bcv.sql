...
-- =====================================================
-- Fecha: 2025-09-23
-- Propósito: Verificar estado completo de la tabla tasa_cambio
-- =====================================================
...
-- 3. Todos los registros de tasa de cambio (últimos 20)
SELECT 
    id,
    fecha,
    tasa_bcv,
...
SELECT 
    ...
    'Última actualización: ' || MAX(updated_at) AS ultima_actualizacion
FROM tasa_cambio;
