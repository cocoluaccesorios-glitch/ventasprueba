-- =====================================================
-- SCRIPT CORREGIDO PARA ARREGLAR SISTEMA DE ABONOS
-- =====================================================

-- 1. CREAR TABLA TASA_CAMBIO (CON PRECISIÓN CORRECTA)
CREATE TABLE IF NOT EXISTS tasa_cambio (
    id SERIAL PRIMARY KEY,
    fecha DATE NOT NULL,
    tasa_bcv DECIMAL(10,2) NOT NULL,  -- Cambiado de (10,8) a (10,2)
...
-- 2. CREAR TABLA ABONOS (CON PRECISIÓN CORRECTA)
...
-- 3. AGREGAR COLUMNAS FALTANTES A LA TABLA PEDIDOS
...
-- 4. ACTUALIZAR PEDIDOS EXISTENTES DE ABONO
UPDATE pedidos 
SET 
    es_abono = TRUE,
...
-- 5. MIGRAR ABONOS EXISTENTES A LA TABLA ABONOS
INSERT INTO abonos (
    pedido_id,
    cliente_id,
    monto_abono_usd,
...
-- 7. CREAR FUNCIÓN PARA CALCULAR SALDO PENDIENTE
...
-- 8. CREAR VISTA PARA RESUMEN DE DEUDAS
...
-- 9. VERIFICAR CREACIÓN Y MIGRACIÓN
SELECT 
...
-- 10. MOSTRAR PEDIDOS DE ABONO ACTUALIZADOS
SELECT 
...
-- 12. VERIFICAR SALDOS PENDIENTES
SELECT 
