-- =====================================================
-- SCRIPT CON 4 DECIMALES PARA ARREGLAR SISTEMA DE ABONOS
-- =====================================================
...
-- PASO 2: ACTUALIZAR TODOS LOS VALORES DE TASA_BCV A 166.5800 PRIMERO
UPDATE pedidos SET tasa_bcv = 166.5800 WHERE tasa_bcv IS NOT NULL;

-- PASO 3: AHORA CAMBIAR EL TIPO DE COLUMNA A 4 DECIMALES
ALTER TABLE pedidos ALTER COLUMN tasa_bcv TYPE DECIMAL(10,4);
