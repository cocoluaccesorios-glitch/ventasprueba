-- =====================================================
-- SCRIPT FINAL PARA ARREGLAR SISTEMA DE ABONOS
-- =====================================================

-- 1. PRIMERO CORREGIR LA COLUMNA TASA_BCV EN PEDIDOS
-- Cambiar la precisión de la columna tasa_bcv existente
ALTER TABLE pedidos ALTER COLUMN tasa_bcv TYPE DECIMAL(10,2);

-- 2. CREAR TABLA TASA_CAMBIO (CON PRECISIÓN CORRECTA)
...
-- 3. CREAR TABLA ABONOS (CON PRECISIÓN CORRECTA)
...
-- 4. AGREGAR COLUMNAS FALTANTES A LA TABLA PEDIDOS
...
-- 5. ACTUALIZAR PEDIDOS EXISTENTES DE ABONO
UPDATE pedidos 
SET 
    es_abono = TRUE,
...
-- 6. MIGRAR ABONOS EXISTENTES A LA TABLA ABONOS
INSERT INTO abonos (
    pedido_id,
    cliente_id,
    monto_abono_usd,
...
-- 8. CREAR FUNCIÓN PARA CALCULAR SALDO PENDIENTE
...
-- 9. CREAR VISTA PARA RESUMEN DE DEUDAS
...
-- 10. VERIFICAR CREACIÓN Y MIGRACIÓN
SELECT 
...
-- 11. MOSTRAR PEDIDOS DE ABONO ACTUALIZADOS
SELECT 
...
-- 13. VERIFICAR SALDOS PENDIENTES
SELECT 
